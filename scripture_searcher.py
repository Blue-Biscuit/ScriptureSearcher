...
def print_help(help_arg: list[str]):
    ...
    if not help_arg:
        ...
        if len(help_arg) == 1:
            ...
            print('\t\tlexeme λογος --case genitive')
            print()
            ...
            print('\t\tlexeme λογος --case dative and lexeme λογος --number singular or lexeme λογος --case genitive and lexeme λογος --number plural')
            print()
            ...
            print('\t\t[lexeme λογος --case genitive or lexeme λογος --case dative] and lexeme λογος --number singular')
            print()
            ...
            print()
            print('LEXEME:')
            print('\tThe lexeme to search for. This can be any regular expression.')
            print()
            print('ARGS:')
            ...
            print('\tvoice\t\t\tThe voice of a word.')
            print('\tmood\t\t\tThe mood of a word.')
            print('\tperson\t\t\tThe person of a word.')
            print()
            print('VALUE:')
